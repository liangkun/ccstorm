...
if (THRIFT_COMPILER)
    ...
    function(thrift_gen_cpp thrift_file THRIFT_CPP_FILES_LIST THRIFT_GEN_INCLUDE_DIR)
        ...
        if(EXISTS ${thrift_file})
            ...
            file(GLOB_RECURSE __skeleton_src "${CMAKE_BINARY_DIR}/${_target_dir}/*.skeleton.cpp")
            file(REMOVE ${__skeleton_src})
...
message("-- Thrift library path: ${THRIFT_LIBRARIES}")
message("-- Thrift compiler: ${THRIFT_COMPILER}")
